          ...
          <div className="container" id="products">
            ...
            {filteredItem.map((item)=>
              <div className="col-sm-6 col-lg-4 text-center item mb-4">
                ...
                <a href="/selectlogin"> <img src={item.image} alt="Image" style={{ width:'250px', height:'250px' }}/></a>
                <h3 className="text-dark"><a href="/selectlogin" style={{fontSize: '25px'}}>{item.name}</a></h3>
